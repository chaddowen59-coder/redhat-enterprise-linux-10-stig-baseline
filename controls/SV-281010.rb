control 'SV-281010' do
  ...
  tag cci: ['CCI-000068', 'CCI-000877', 'CCI-001453', 'CCI-002890', 'CCI-003123', 'CCI-002418']
  tag nist: ['CM-6 b']
  tag 'host'
  tag 'container'

  describe command("grep -i Ciphers /etc/crypto-policies/back-ends/openssh.config") do
